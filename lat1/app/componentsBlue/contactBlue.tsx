...
import { warnaformHijauToscaBiruMuda } from '../color';
  ...
  return (
    <div>
      <h1
        ...
        style={{
          textAlign: 'center',
          color: warnaformHijauToscaBiruMuda.textColor,
          textShadow: warnaformHijauToscaBiruMuda.boxShadow,
      ...
      <div
        ...
        style={{
          border: `2px solid ${warnaformHijauToscaBiruMuda.border}`,
          borderImage: `${warnaformHijauToscaBiruMuda.gradient} 1`,
          padding: '20px',
          backgroundColor: warnaformHijauToscaBiruMuda.background,
          borderRadius: '15px',
          maxWidth: '600px',
          margin: '20px auto',
          color: warnaformHijauToscaBiruMuda.textColor,
      ...
      Average Rating: {averageRating} stars
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '15px' }}>
              <button
                ...
                onClick={resetForm}
                style={{
                  backgroundColor: warnaformHijauToscaBiruMuda.buttonBg,
                  color: warnaformHijauToscaBiruMuda.buttonText,
                  padding: '10px 20px',
                  border: 'none',
                  borderRadius: '10px',
                  cursor: 'pointer',
                ...
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = warnaformHijauToscaBiruMuda.buttonBg} // Revert effect
              >
                Back
              </button>
            </div>
          ...
          <form onSubmit={handleSubmit} style={{ color: warnaformHijauToscaBiruMuda.textColor }}>
              ...
              <div style={{ display: 'flex', gap: '5px', marginTop: '5px' }}>
                {[1, 2, 3, 4, 5].map((star) => (
                  <span
                    ...
                    style={{
                      cursor: 'pointer',
                      color: (hoverRating || rating) >= star ? warnaformHijauToscaBiruMuda.textColor : warnaformHijauToscaBiruMuda.starInactive,
                      fontSize: '1.5em',
                    }}
